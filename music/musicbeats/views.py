...
from musicbeats.models import Song, Watchlater, History, Channel, Artist, Albums
...
def artistLogin(request):
    ...
    return render(request, 'musicbeats/artistlogin.html')
...
def artistSignUp(request):
    ...
    return render(request, 'musicbeats/artistSignup.html')
